  ...
  return (
    <main>
      <section className="p-strip" style={{ backgroundColor: '#fcfcfc', borderBottom: '1px solid #eaeaea', padding: '3.5rem 0' }}>
        <div className="row u-vertically-center">
          ...
          <div className="col-4 col-medium-1 u-align--center">
            <FaFileSignature style={{ fontSize: '5rem', color: 'var(--vf-color-brand)', opacity: 0.85, filter: 'drop-shadow(0 8px 16px rgba(233, 84, 32, 0.15))' }} />
          </div>
        </div>
      </section>
      ...
      <section className="p-strip" style={{ backgroundColor: '#ffffff' }}>
        <div className="row">
          <div className="col-8 col-medium-5">
            <h3 style={{ color: 'var(--vf-color-accent)', fontWeight: 700 }}>Our Code of Conduct</h3>
            ...
            <h4 style={{ color: 'var(--vf-color-brand)', fontWeight: 700 }}>1. Be Respectful</h4>
            <p>
            ...
            <h4 style={{ color: 'var(--vf-color-brand)', fontWeight: 700 }}>2. Be Collaborative</h4>
            <p>
            ...
            <h4 style={{ color: 'var(--vf-color-brand)', fontWeight: 700 }}>3. Harassment-Free Space</h4>
            <p>
          ...
          <div className="col-4 col-medium-1">
            <div className="p-card" style={{ backgroundColor: '#fcfcfc' }}>
              <h4 style={{ color: 'var(--vf-color-accent)', fontWeight: 700 }}>Quick Links</h4>
              <hr className="p-rule" />
              <ul className="p-list">
      ...
      <section className="p-strip" style={{ backgroundColor: 'rgba(119, 41, 83, 0.04)', borderTop: '1px solid rgba(119, 41, 83, 0.1)', borderBottom: '1px solid rgba(119, 41, 83, 0.1)' }}>
        <div className="row">
          <div className="col-8 col-medium-5">
            <h3 style={{ color: 'var(--vf-color-accent)', fontWeight: 700 }}>Reporting Incidents</h3>
            <p>
            ...
            <div className="p-notification--information" style={{ marginTop: '1.5rem', backgroundColor: '#ffffff' }}>
              <div className="p-notification__content">
                <h5 className="p-notification__title" style={{ color: 'var(--vf-color-accent)' }}>Need Help?</h5>
