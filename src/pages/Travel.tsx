  ...
  return (
    <main>
      <section className="p-strip" style={{ backgroundColor: 'var(--bg-dark)', borderBottom: '1px solid var(--border-main)', padding: '3.5rem 0' }}>
        <div className="row u-vertically-center">
          ...
          <div className="col-4 col-medium-1 u-align--center">
            <FaPlane style={{ fontSize: '5rem', color: 'var(--text-main)', opacity: 0.85, filter: 'drop-shadow(0 8px 16px var(--overlay-orange-strong))' }} />
          </div>
        </div>
      </section>
      ...
      <section className="p-strip" style={{ backgroundColor: 'var(--bg-dark-alt)' }}>
        <div className="row">
          <div className="col-8 col-medium-5">
            <h3 style={{ color: 'var(--text-main)', fontWeight: 700, marginBottom: '1.5rem' }}>Transit Guidelines</h3>
            ...
            <h4 style={{ display: 'flex', alignItems: 'center', color: 'var(--text-main)', fontWeight: 700 }}>
          ...
          <div className="col-4 col-medium-1">
            <div className="p-card" style={{ borderLeft: '4px solid var(--vf-color-accent)', backgroundColor: 'var(--bg-dark-alt)', height: '100%' }}>
              <h4 style={{ color: 'var(--text-main)', fontWeight: 700 }}>Quick Stats</h4>
              <hr className="p-rule" />
              <ul className="p-list">
      ...
      <section className="p-strip" style={{ backgroundColor: 'var(--overlay-orange-light)', borderTop: '1px solid rgba(233, 84, 32, 0.1)', borderBottom: '1px solid rgba(233, 84, 32, 0.1)' }}>
        <div className="row">
          <div className="col-8 col-medium-5">
            <h3 style={{ color: 'var(--text-main)', fontWeight: 700, display: 'flex', alignItems: 'center', marginBottom: '1.5rem' }}>
              <FaPassport style={{ marginRight: '0.75rem', color: 'var(--text-main)' }} /> Visa Requirements
            </h3>
            <p>
            ...
            <div className="p-notification--information" style={{ marginTop: '1.5rem', backgroundColor: 'var(--bg-dark-alt)', borderColor: '#772953' }}>
              <div className="p-notification__content">
                <h5 className="p-notification__title" style={{ color: '#fff' }}>Visa Invitation Letters</h5>
